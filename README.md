...
Press **O** in a world to open VoiceInject settings and choose **Hold** or **Tap** mode. The mode is saved in `config/voiceinject.json`. All three keybinds can be changed in Minecraft Controls.
